...
export interface FeaturedVehiclesSectionProps {
  vehicles: Vehicle[];
  isLoading?: boolean;
  /** Optional: show landed price in NGN on each card. If true, estimated landed cost is computed. */
...
export function FeaturedVehiclesSection({
  ...
  return (
    <section className="py-20 bg-[#F8FAFC]" aria-labelledby="featured-vehicles-heading">
