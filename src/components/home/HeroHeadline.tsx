...
export function HeroHeadline({ headerText, descriptionText }: HeroHeadlineProps) {
  return (
    <div className="flex flex-col justify-center items-center gap-4 sm:gap-[21px] w-full max-w-[602px]">
      <h1 className="font-sans font-bold text-2xl sm:text-3xl md:text-[48px] md:leading-[60px] leading-tight sm:leading-snug text-white text-left w-full shrink-0 order-0" dangerouslySetInnerHTML={{ __html: headerText as string }}>
