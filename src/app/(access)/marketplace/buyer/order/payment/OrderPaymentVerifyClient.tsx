...
export type OrderPaymentVerifyClientProps = {
  reference?: string;
  trxref?: string;
...
export default function OrderPaymentVerifyClient({
  reference,
  trxref,
  transactionId,
  cancelled,
}: Readonly<OrderPaymentVerifyClientProps>) {
  ...
  }, [cancelled, paymentRef, verifyPayment, router]);
      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-50">
        <div className="max-w-md rounded-xl bg-white p-8 text-center shadow-sm">
          ...
          <p className="mb-4 text-sm text-gray-600">
            You cancelled the payment. You can return to your dashboard and try
            again.
          </p>
          <button
            type="button"
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50">
        <div className="max-w-md rounded-xl bg-white p-8 text-center shadow-sm">
          ...
          <p className="mb-4 text-sm text-gray-600">
            We couldn&apos;t find a payment reference in the URL. Please start
